...
```bibtex
@software{cell_viability_analysis,
  title={Cell Viability Analysis: Automated Cell Classification Using AI},
  author={Your Name},
  year={2024},
  url={https://github.com/yourusername/cell-viability-analysis}
}
```
...
@article{stringer2021cellpose,
  ...
  author={Stringer, Carsen and Wang, Tim and Michaelos, Michael and Pachitkanu, Ann and 
          Inci, Feryal and Falk, Matthias and others},
...
- **Cellpose**: For the excellent cell segmentation algorithm
...
- 🐛 Issues: [GitHub Issues](https://github.com/yourusername/cell-viability-analysis/issues)
- 💬 Discussions: [GitHub Discussions](https://github.com/yourusername/cell-viability-analysis/discussions)

## 🔄 Changelog

### v1.0.0 (2024-03-24)
- ✨ Initial release
- 🤖 Cellpose4 integration with SAM
- 🔬 Dual classification methods
